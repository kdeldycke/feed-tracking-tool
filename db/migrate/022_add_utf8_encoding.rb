class AddUtf8Encoding < ActiveRecord::Migration
  def self.up
    ...
    execute("ALTER TABLE article MODIFY description text character set utf8;")
    ...
    execute("ALTER TABLE profile MODIFY display_name varchar(255) character set utf8;")
    
    execute("ALTER TABLE rssfeed MODIFY title varchar(255) character set utf8;")
    execute("ALTER TABLE rssfeed MODIFY description text character set utf8;")
